...
<div class="container gap-2" style="padding-top: 150px">
    <div class="row">
        ...
        <div class="col">
          <h2>리뷰게시판</h2>
          <hr>
            <h6><b>클릭한 게시물의 제목</b></h6><p style="text-align:right;">${review.email }</p>
            <hr>
              <img class="img" style="width: 300px;" src="https://movie-phinf.pstatic.net/20210917_60/16318534287592XLg8_JPEG/movie_image.jpg" alt="">
              
                <p>
                  같은말을 반복하니까 무서워서 다른말을 써야겠습니다
              </p>
              <hr>
